...
function child_enqueue_styles() {
	...
	$fs_js_ver  = date("ymd-Gis", filemtime( get_stylesheet_directory() . '/js/ajax.js' ));

	wp_enqueue_style( 'full-scale-style-css', get_stylesheet_directory_uri() . '/style.css', ['astra-theme-css'], $fs_css_ver, 'all' );
	wp_enqueue_script( 'full-scale-script-script', get_stylesheet_directory_uri() . '/js/scripts.js', [], $fs_script_ver, true );
}
